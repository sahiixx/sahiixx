...
![repos](https://img.shields.io/badge/repos-240%20(94%20originals%20%C2%B7%20146%20forks)-111111?style=flat-square)
...
> Everything below is grounded in a live read-only scrape of this account (2026-09-19): **240 repos**, an **11-service Cloudflare edge**, and the links between them. Unverifiable marketing numbers were deliberately left out.
...
flowchart TD
    ...
    RE[Dubai Real-Estate Revenue<br/>sovereign-revenue-os · nexus-buyer-recovery · sovereign-agents · lazy-ai-ops · FirstCall]
    ...
    FORK[Fork Study Library<br/>146 upstream repos]
...
**2. A Dubai real-estate revenue vertical.** `sovereign-revenue-os`, `nexus-buyer-recovery`, `sovereign-agents`, `lazy-ai-ops` and **`FirstCall`** (idempotent UAE-leads ingestion -> FastAPI) implement the pipeline: capture -> qualify -> geo-match -> schedule -> report. Mostly **private** — this is the commercial side.
...
| **Verticals** | revenue systems | `sovereign-revenue-os`, `nexus-buyer-recovery`, `sovereign-agents`, `lazy-ai-ops`, `FirstCall` |
...
- **Dubai real-estate revenue (12):** `FirstCall`, `sovereign-revenue-os`, `nexus-buyer-recovery`, `sovereign-agents`, `sovereign-prompt-pack`, `lazy-ai-ops`, `sahiix-os-docs`, `sahiix-portfolio`, `ae-lead-scraper---`, `campaigns`, `UAE-deal-`, `v0-nowire-os-blueprint`
...
| Other / curated | 21 | `UI-TARS-desktop`, `rasa`, `adk-python`, `llm-council`, `500-AI-Agents-Projects` |
...
| 500 AI Agents projects | [500-ai-agents-projects.pages.dev](https://500-ai-agents-projects.pages.dev) | unreachable (HTTP 523) - not resolving |
...
## By the numbers (scraped 2026-09-19)

- **240 repos total** — 94 originals + 146 forks · **218 public / 22 private** · **31 stars**
- **Top languages** — Python 73 · TypeScript 65 · JavaScript 14 · HTML 12 · Go 8 · Rust 8 · Kotlin 6
...
- Hardening the **Lead Machine** real-estate pipeline (`FirstCall` → capture → qualify → geo-match → revenue).
